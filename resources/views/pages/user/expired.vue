            ...
            <tbody v-if="user_rent.length">
              <tr
                ...
                <td>
                  ...
                  <InertiaLink :href="route('user.return_product',user_renteds?.id)" class="btn btn-outline-primary btn-sm me-2"
                  v-if="user_renteds.return_request == 0"
                  >
                    Confirm Return
                    <i class="mdi mdi-arrow-right ms-1"></i>
                  </InertiaLink>
                  <button class="btn btn-sm btn-outline-info" disabled v-if="user_renteds.return_request == 1 ">
                ...
                <td>
                  ...
                  >
                    <span class="badge bg-danger py-1 w-100">
                      <h6 class="text-white">
                        Expired by
                        {{
